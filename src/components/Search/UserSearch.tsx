                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="relative">
                        {user.avatar ? (
                          <img
                            ...
                            alt={user.username}
                            className={`w-12 h-12 rounded-full border border-green-500/30 ${isAppCreator ? 'ring-2 ring-yellow-400' : ''}`}
                          />
                        ) : (
                          <div className={`w-12 h-12 rounded-full bg-gray-700 border border-green-500/30 flex items-center justify-center ${isAppCreator ? 'ring-2 ring-yellow-400' : ''}`}>
                            <UserCircle className={`${isAppCreator ? 'text-yellow-400' : 'text-green-400'}`} size={28} />
                          </div>
                        )}
                        {user.is_online && (
                      ...
                      <div>
                        <h3 className={`font-semibold ${isAppCreator ? 'text-yellow-400 font-bold' : 'text-gray-200'}`}>
                          {user.username}
                        </h3>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <div
                            className={`w-2 h-2 rounded-full ${user.is_online ? 'bg-green-400' : 'bg-gray-500'}`}
                          ></div>
